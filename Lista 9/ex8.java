/*8. Faca um programa que conte o numero de 1ß que aparecem em um string. Exemplo: ”0011001¿ 3 ´*/
...
public class ex8 {
    public static void main(String[] args) {
        ...
        int cont = 0;
        System.out.println(
                " Contar quantas vezes um dado caractere aparece na string. Esse caractere desse ser informado pelo usuario ");
        System.out.println();
